...
export default function Index({ notifications }) {
    ...
    // "Belum dibaca" dihitung dari is_read biasa sekarang, termasuk untuk pengumuman
    // (pengumuman sekarang 1 baris per user, jadi is_read-nya per orang, bukan shared lagi).
            ...
            <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="divide-y divide-navy/5">
                    {items.length === 0 ? (
                        ...
                        items.map((item) => {
                            // Ikon pengumuman ditentukan dari "type", bukan dari user_id/is_broadcast lagi —
                            // sejak pengumuman disimpan sebagai 1 baris per user (lihat NotificationService::announcementCreated).
                            const isAnnouncement = item.type === 'pengumuman';
